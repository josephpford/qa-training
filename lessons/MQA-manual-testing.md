...
We will not be creating a Test Plan document as part of this training. They are generally created by Test Leads at the beginning of a Waterfall Project. Some SOX or FDA regulated environments may require Test Plan documents for compliance reasons. 
...
### Test Case 1: Delete a non-existing Solar Panel
Pre-condition: The database is initialized with 0 solar panels
...
You can read more about traceability matrices here:
...
## Next
[Defect Reports](./MQA-defect-reports.md)
